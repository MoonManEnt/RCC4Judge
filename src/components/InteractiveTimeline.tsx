    ...
    <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-all duration-300 ${
                    isActive
                      ? `${eventColors.bg} text-white shadow-lg scale-110 ring-4 ${eventColors.ring}`
                      : "bg-white border-2 border-cream-dark text-charcoal-light hover:border-forest/40 hover:scale-105"
                  }`}
                >
      ...
      >
        <div className="flex items-start gap-4 mb-6">
          <div className={`w-12 h-12 rounded-2xl ${colors.bgLight} flex items-center justify-center flex-shrink-0`}>
