...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-cream-dark pb-24 lg:pb-0">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            />
            <p className="text-charcoal-light text-sm font-body leading-relaxed mt-2">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-body text-sm font-bold text-forest tracking-widest uppercase mb-4">
              Quick Links
            </h4>
            <nav className="grid grid-cols-3 gap-x-4 gap-y-2">
              {FOOTER_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-charcoal-light text-sm font-body hover:text-amber transition-colors"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <p className="text-charcoal-light text-sm font-body leading-relaxed mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/volunteer"
                className="inline-flex items-center justify-center px-5 py-2.5 border border-forest/30 text-forest text-sm font-medium font-body rounded-full hover:bg-forest/5 transition-colors"
              >
                Volunteer
              </Link>
            </div>
            <div className="mt-5">
              <p className="text-charcoal-light text-xs font-body font-medium mb-2">Campaign Updates:</p>
              <EmailSignup />
            </div>
            <p className="text-charcoal-light/60 text-xs font-body mt-4">
        ...
        <div className="border-t border-cream-dark py-6">
          <div className="text-center space-y-2">
            <p className="text-charcoal-light/40 text-[10px] font-body leading-relaxed">
              Paid for by RCC for Chancery 2026, P.O. Box 74, Tougaloo, MS 39174. Sotderia Griffin, Treasurer.
            </p>
            <p className="text-charcoal-light/40 text-xs font-body leading-relaxed">
            ...
            <p className="text-charcoal-light/30 text-xs font-body mt-4">
